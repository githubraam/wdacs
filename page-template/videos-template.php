...
if ($videos->have_posts()): while ($videos->have_posts()): $videos->the_post();?>
                ...
                <div class="col-md-6 col-lg-4 col-sm-6 mb-4 content_wrap">
        ...
        ?>
                            ...
                            <img src="<?php echo get_template_directory_uri(); ?>/images/play-btn.png" class="playbtnv img-fluid" data-videoid="<?php echo get_the_ID(); ?>" data-videotitle="<?php the_title();?>" >
