...
?>
			<a target="_blank" href="<?=get_sub_field('block_link')?>" class="box text-center">

				<img src="<?=get_sub_field('block_icon')?>" class="img-fluid">

				<p class="title"><?=get_sub_field('block_title')?></p>
